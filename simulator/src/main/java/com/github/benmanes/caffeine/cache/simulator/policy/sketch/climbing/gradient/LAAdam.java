 ...
 * This optimizer try to optimize based on access times instead of hit ratio.
 * @author himelbrand@gmail.com (Omri Himelbrand)
 */
public final class LAAdam extends AbstractLAClimber {
  ...
  static final class AdamSettings extends BasicSettings {
    static final String BASE_PATH = "la-hill-climber-window.adam.";
