 ...
 */
public final class WindowLATinyLfuPolicy implements Policy {
  ...
  public WindowLATinyLfuPolicy(double percentMain, WindowTinyLfuSettings settings) {
    String name = String.format("sketch.WindowLATinyLfu (%.0f%%)", 100 * (1.0d - percentMain));
  ...
  public static Set<Policy> policies(Config config) {
    ...
    return settings.percentMain().stream()
        .map(percentMain -> new WindowLATinyLfuPolicy(percentMain, settings))
        .collect(toSet());
  }
